...
class Key_Value():
    def __init__(self):
        ...
        #host info
        self.host_email = 'rainman.tai@gmail.com'
        
        #login information
        self.unknown_user = 'unknown_user'
        
        #package status
        self.package_status_dict = {'client':' at client\'s place.', 'pickup':' picked up by ExShipper.', 'exshipper':' at ExShipper.', 'apex':' at Apex', 'sfo_airport':' at SFO Airport.', 'taiwan_taoyuan_airport':' at Taiwan Taoyuan Airport.', 'tw_custom_entry':' at the custom entry company.', 'tw_logistics':' at the local logistics company (SUDA).', 'delivered':' delivered.'}
