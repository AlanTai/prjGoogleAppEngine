...
#                     log_spearnet_customer_package_info = data
        ...
        # page of handling exshipper pre-alert
            ...
            pre_alert_package_entity = TWCustomEntryInfo.query(ndb.OR(TWCustomEntryInfo.package_status == 'exshipper',
                                                              TWCustomEntryInfo.mawb != None,
                                                              TWCustomEntryInfo.flight_date != None)).get()
            pre_alert_packages_list = TWCustomEntryInfo.query(ndb.OR(TWCustomEntryInfo.package_status == 'exshipper',
                                                              TWCustomEntryInfo.mawb != None,
                                                              TWCustomEntryInfo.flight_date != None))
